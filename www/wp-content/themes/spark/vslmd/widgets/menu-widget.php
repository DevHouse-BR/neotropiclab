...
class Vslmd_Menu_Widget extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		$nav_menu_args = array(
			...
			'menu_class' => 'nav navbar-nav t_link '.$instance['alignment'].' '.$instance['navigation_structure'].'',
			'menu_id' => 'widget-menu',
			'fallback_cb' => '',
		...
		<div class="nav-menu-widget-form-controls" <?php if ( empty( $menus ) ) { echo ' style="display:none" '; } ?>>
			...
			<p>
				...
				<select id="<?php echo $this->get_field_id( 'alignment' ); ?>" class="widefat" name="<?php echo $this->get_field_name( 'alignment' ); ?>">
					...
					<option value="navbar-left" <?php selected( $alignment, 'navbar-left'); ?>><?php _e( 'Left' ); ?></option>
				    <option value="navbar-center" <?php selected( $alignment, 'navbar-center'); ?>><?php _e( 'Center' ); ?></option>
				    <option value="navbar-right" <?php selected( $alignment, 'navbar-right'); ?>><?php _e( 'Right' ); ?></option>
				</select>
			</p>
			<p>
